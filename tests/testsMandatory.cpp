...
TEST(BasisRfuncs, Mandatory) {
    ...
    ASSERT_NEAR(arma::norm(basis.rPart(r, 0, 0) - res00), 0.0, 1e-15);
    ...
    ASSERT_NEAR(arma::norm(basis.rPart(r, 8, 2) - res82), 0.0, 1e-15);
}

TEST(BasisZfuncs, Mandatory) {
...
// br = 1.935801664793151, bz = 2.829683956491218, N = 14, Q = 1.3
    ...
    ASSERT_NEAR(arma::norm(basis.zPart(z, 0) - res00), 0.0, 1e-15);
    ...
    ASSERT_NEAR(arma::norm(basis.zPart(z, 15) - res15), 0.0, 1e-15);
}
